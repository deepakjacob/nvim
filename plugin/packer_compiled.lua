...
_G.packer_plugins = {
  ...
  ["nvim-ts-rainbow"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/jacobdeepak/.local/share/nvim/site/pack/packer/opt/nvim-ts-rainbow",
  ...
  ["vscode.nvim"] = {
    ...
    loaded = true,
    path = "/Users/jacobdeepak/.local/share/nvim/site/pack/packer/start/vscode.nvim",
